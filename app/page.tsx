export default function Home() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#050B16] text-white">
      ...
      <div className="absolute -top-20 left-1/2 h-[420px] w-[420px] -translate-x-1/2 rounded-full bg-[#FF6B3D]/10 blur-3xl" />

      <section className="relative z-10 flex min-h-screen flex-col items-center justify-center px-6 py-16">
        <div className="mx-auto w-full max-w-3xl text-center">
          <div className="relative mx-auto mb-9 flex justify-center">
            <div className="absolute top-1/2 h-56 w-56 -translate-y-1/2 rounded-full bg-[#FF6B3D]/25 blur-3xl animate-pulse" />
            <div className="absolute top-1/2 h-36 w-[420px] -translate-y-1/2 rounded-full bg-white/10 blur-2xl" />

            <img
              src="/selfward-logo.svg"
              alt="Selfward"
              className="relative z-10 h-28 opacity-95 sm:h-32"
            />
          </div>
